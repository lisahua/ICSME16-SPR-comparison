...
public class TreeMap1_genprog_ga {
	...
	public boolean containsValue(Object value) {
		...
		if (e != null) {
			while (e.left != null) {
				// RBTERR1 genProg generate fix using genetic search without
				// location
				if (tmp == true)
					return true;
				// end RBTERR1 genProg generate fix
				e = e.left;
			}
		...
		while ((e != null) && (cnt < 10)) {
			cnt++;
			//below is the fix of genprog
			if ((value == null)) {
				return true;
			} else {
				tmp = value.equals(e.value);
			}
//end of fix
	...
	public static Boolean test0(TreeMap1_genprog_ga t) {
	...
	public static Boolean test1(TreeMap1_genprog_ga t) {
	...
	public static Boolean test2(TreeMap1_genprog_ga t) {
	...
	public static Boolean test3(TreeMap1_genprog_ga t) {
	...
	public static Boolean test4(TreeMap1_genprog_ga t) {
	...
	public static Boolean test5(TreeMap1_genprog_ga t) {
	...
	public static Boolean test6(TreeMap1_genprog_ga t) {
	...
	public static Boolean test7(TreeMap1_genprog_ga t) {
	...
	public static Boolean test8(TreeMap1_genprog_ga t) {
	...
	public static Boolean test9(TreeMap1_genprog_ga t) {
	...
	public static Boolean test9a(TreeMap1_genprog_ga t) {
	...
	public static Boolean test10(TreeMap1_genprog_ga t) {
	...
	// kill RBTERR1 fix from genprog genetic search without location 
	public static Boolean test11(TreeMap1_genprog_ga t) {
	...
	public static Boolean test0a(TreeMap1_genprog_ga t) {
		// TreeMap1_genprog.t = new TreeMap1_genprog.);
	...
	static public void main(String[] args) {
		...
		TreeMap1_genprog_ga t = new TreeMap1_genprog_ga();
